...
public class SeamRemover {
        ...
        if (var1 == null) {
            ...
            for (int var2 = 0; var2 < var1.length - 2; ++var2) {
                if (Math.abs(var1[var2] - var1[var2 + 1]) > 1) {
                    throw new IllegalArgumentException("Invalid seam, consecutive vertical "
    ...
    public static Picture removeVerticalSeam(Picture var0, int[] var1) {
        if (var1 == null) {
            ...
            for (int var2 = 0; var2 < var1.length - 2; ++var2) {
                if (Math.abs(var1[var2] - var1[var2 + 1]) > 1) {
                    throw new IllegalArgumentException("Invalid seam, consecutive "
                            + "horizontal indices are greater than one apart.");
                }
            }
