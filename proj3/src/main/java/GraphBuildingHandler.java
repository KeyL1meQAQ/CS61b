...
//            System.out.println("Beginning a way...");
            GraphDB.Way way = new GraphDB.Way(attributes.getValue("id"));
            lastWay = way;
            ...
            GraphDB.Node node = g.getNode(attributes.getValue("ref"));
            ...
            if (k.equals("maxspeed")) {
                ...
                lastWay.setMaxSpeed(v);
            } else if (k.equals("highway")) {
                //System.out.println("Highway type: " + v);
                /* TODO Figure out whether this way and its connections are valid. */
                /* Hint: Setting a "flag" is good enough! */
                lastWay.setValid(ALLOWED_HIGHWAY_TYPES.contains(v));
                lastWay.setType(v);
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            GraphDB.Location location = new GraphDB.Location(lastNode.getId(),
